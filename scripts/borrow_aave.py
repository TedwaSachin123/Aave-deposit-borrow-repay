...
def main():
    ...
    print(
        "You just deposited, borrowed, and repayed with Aave using Brownie"
    )
...
def get_borrowable_data(lending_pool, account):
    ...
    #f allow us to print variable inside the print function
